...
public class LyricsDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_FIRST_TABLE = "CREATE TABLE " + LyricsContract.ArtistEntry.TABLE_NAME + " (" +
        ...
        sqLiteDatabase.execSQL(SQL_CREATE_FIRST_TABLE);
        sqLiteDatabase.execSQL(SQL_CREATE_SECOND_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + LyricsContract.ArtistEntry.TABLE_NAME);
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + LyricsContract.ArtistEntry.TABLE_NAME);
